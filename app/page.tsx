    ...
    <div style={{ ...s, color: ink, background: "linear-gradient(170deg, #d6e8f5 0%, #e8f2f9 15%, #f2f7fb 35%, #f8fafb 60%, #ffffff 100%)" }}>
      ...
      <nav style={{ position: "fixed", top: "12px", left: 0, right: 0, zIndex: 50, padding: "0 20px" }}>
        <div style={{ maxWidth: "1080px", margin: "0 auto", background: "#1e6080", borderRadius: "14px", height: "68px", display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 20px 0 24px", boxShadow: "0 4px 24px rgba(0,0,0,0.18)" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "28px" }}>
            ...
            <a href="#contact" style={{ fontSize: "13px", fontWeight: 700, color: "#1e6080", background: "#fff", borderRadius: "10px", padding: "10px 26px", textDecoration: "none", display: "flex", alignItems: "center", gap: "6px", whiteSpace: "nowrap" as const }}>
        ...
        <div style={{ position: "fixed", inset: 0, zIndex: 200 }}>
          ...
          <div style={{ position: "absolute", top: 0, right: 0, bottom: 0, width: "280px", background: "#fff", display: "flex", flexDirection: "column", boxShadow: "-8px 0 32px rgba(0,0,0,0.12)" }}>
            ...
            <div style={{ padding: "16px", display: "flex", flexDirection: "column", gap: "8px" }}>
              ...
              <a href="#contact" onClick={() => setNavOpen(false)} style={{ display: "block", width: "100%", padding: "13px", background: accent, color: "#fff", fontSize: "14px", fontWeight: 700, textDecoration: "none", textAlign: "center" }}>Book a Call</a>
            </div>
          </div>
        </div>
      )}
        ...
        <div className="m-hero-content" style={{ position: "relative", zIndex: 1, maxWidth: "1200px", margin: "0 auto", padding: "150px 40px 110px", width: "100%", display: "grid", gridTemplateColumns: "1.15fr 1fr", gap: "56px", alignItems: "center" }}>
          <div>
            ...
            <div className="hero-ctas" style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "16px", flexWrap: "wrap" }}>
              <a href="#contact" className="btn btn-dark btn-hero" style={{ fontSize: "14px", padding: "12px 22px" }}>
      ...
      <section style={{ background: "transparent", padding: "100px 40px 80px", borderTop: `1px solid ${line}` }}>
        <div className="m-calendar-grid" style={{ maxWidth: "1200px", margin: "0 auto", display: "grid", gridTemplateColumns: "1fr auto", gap: "64px", alignItems: "center" }}>
          <div>
            ...
            <a href="#contact" className="lp-rise d3 btn btn-dark" style={{ fontSize: "14px", padding: "13px 26px", marginBottom: "48px" }}>
              Book a Call <ArrowRight style={{ width: "13px", height: "13px" }} />
            </a>
      ...
      <section style={{ position: "relative", overflow: "hidden", background: "linear-gradient(180deg, #ffffff 0%, #eef5fb 55%, #ffffff 100%)", padding: "40px 40px 32px", borderTop: `1px solid ${line}` }}>
        ...
        <div style={{ position: "relative", maxWidth: "1100px", margin: "0 auto", textAlign: "center" as const }}>
          ...
          <a href="#contact" className="lp-rise d3 btn btn-dark" style={{ fontSize: "14px", padding: "13px 28px", marginTop: "20px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column" as const, gap: "16px" }}>
            ...
            <div className="m-solution-split" style={{ border: `1px solid ${line}`, display: "grid", gridTemplateColumns: "1fr 1fr" }}>
              <div style={{ padding: "40px 44px", borderRight: `1px solid ${line}` }}>
                ...
                <a href="#contact" className="btn btn-dark" style={{ fontSize: "13px", padding: "10px 18px" }}>
      ...
      <section style={{ background: "transparent", padding: "96px 40px", borderTop: `1px solid ${line}` }}>
        ...
        >
          ...
          <div style={{ textAlign: "center" as const, marginTop: "48px" }}>
            <a href="#contact" className="btn btn-dark" style={{ fontSize: "14px", padding: "13px 28px" }}>
          ...
          <div className="lp-rise" style={{ border: `1px solid ${line}`, padding: "64px 48px", position: "relative" as const, overflow: "hidden" }}>
            <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", gap: "48px", flexWrap: "wrap" as const, position: "relative" as const, zIndex: 1 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column" as const, gap: "12px", minWidth: "260px" }}>
                <a href="mailto:lsgrowthagency.co@gmail.com" className="btn btn-dark" style={{ fontSize: "14px", padding: "16px 28px", justifyContent: "center" }}>
                  Book a Free Call <ArrowRight style={{ width: "14px", height: "14px" }} />
                </a>
